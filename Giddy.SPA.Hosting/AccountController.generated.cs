...
namespace Giddy.SPA.Hosting.Controllers.Web
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_AccountController : Giddy.SPA.Hosting.Controllers.Web.AccountController
    {
        ...
        partial void LoginOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Giddy.SPA.Hosting.Models.LoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult Login(Giddy.SPA.Hosting.Models.LoginModel model, string returnUrl)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Login);
        ...
        partial void RegisterOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Giddy.SPA.Hosting.Models.RegisterModel model);

        public override System.Web.Mvc.ActionResult Register(Giddy.SPA.Hosting.Models.RegisterModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Register);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Giddy.SPA.Hosting.Controllers.Web.AccountController.ManageMessageId? message);

        public override System.Web.Mvc.ActionResult Manage(Giddy.SPA.Hosting.Controllers.Web.AccountController.ManageMessageId? message)
        {
        ...
        partial void ManageOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Giddy.SPA.Hosting.Models.LocalPasswordModel model);

        public override System.Web.Mvc.ActionResult Manage(Giddy.SPA.Hosting.Models.LocalPasswordModel model)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Manage);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "model", model);
        ...
        partial void ExternalLoginConfirmationOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Giddy.SPA.Hosting.Models.RegisterExternalLoginModel model, string returnUrl);

        public override System.Web.Mvc.ActionResult ExternalLoginConfirmation(Giddy.SPA.Hosting.Models.RegisterExternalLoginModel model, string returnUrl)
        {
